...
extern void RGBSet(volatile const uint32_t * pui32RGBColor, float fIntensity);
extern void RGBColorSet(volatile const uint32_t * pui32RGBColor);

extern void RGBIntensitySet(float fIntensity);
extern void RGBBlinkRateSet(float fRate);
extern void RGBColorGet(uint32_t * pui32RGBColor);
